 ...
 * Team Members: 
 *              Project Manager(Previously): Arsh Ahluwalia   
                Project Manager(Current): Aryan Arora
                Lead Programmer: Jugal Bilimoria
                Graphics Artist(Previously): Arsh Ahluwalia
                Graphics Artist(Current): Jugal Bilimoria
                Systems Analyst: Aryan Arora
                Technical Writer(Previously): Zahra Ahmed
                Technical Writer(Currently): Aryan Arora

 * Date: August 5th - August 8th 2019s
 * Program Description: A connect 4 game for the user to play with the computer
 */
package ConnectFour;
...
public class ConnectFour extends javax.swing.JFrame {
    ...
    //setting up image icon with the images of pieces of the 2 colours
    ImageIcon red = new ImageIcon("red.png");
    ImageIcon yellow = new ImageIcon("yellow.png");
    ImageIcon blank = new ImageIcon("blank.png");
    
    //initializing variables which are used throughou the entire program 
    String name = ""; //this string is to store your name for the scoreboard
    int numberOfTurns = 0; //this is to count how mnay terns you have made for the scoreboard
    int selectedColumn = 0; 
    //arrays and array lists for the game board, scoreboard and computer picks
    ...
    //initializes random method
    Random rand = new Random(); 
    //links this class and the ConnectFourClass in order to call methods from that class
    ConnectFourClass cf = new ConnectFourClass(); 
    ...
    private void initComponents() {
        ...
        txtCredits.setText("\n                   Project Manager(Previously): Arsh Ahluwalia   \n                   Project Manager(Current): Aryan Arora\n                   Lead Programmer: Jugal Bilimoria\n                   Graphics Artist(Previously): Arsh Ahluwalia\n                   Graphics Artest(Current): Jugal Bilimoria\n                   Systems Analyst: Aryan Arora\n                   Technical Writer(Previously): Zahra Ahmed\n                   Technical Writer(Currently): Aryan Arora");
        ...
        gameboard.setIcon(new javax.swing.ImageIcon(getClass().getResource("/ConnectFour/board.png"))); // NOI18N
        ...
        slot7.setIcon(new javax.swing.ImageIcon(getClass().getResource("/ConnectFour/blank.png"))); // NOI18N
        pnlBackground.add(slot7, new org.netbeans.lib.awtextra.AbsoluteConstraints(710, 70, 80, 80));

        slot6.setIcon(new javax.swing.ImageIcon(getClass().getResource("/ConnectFour/blank.png"))); // NOI18N
        pnlBackground.add(slot6, new org.netbeans.lib.awtextra.AbsoluteConstraints(602, 70, 80, 80));

        slot5.setIcon(new javax.swing.ImageIcon(getClass().getResource("/ConnectFour/blank.png"))); // NOI18N
        pnlBackground.add(slot5, new org.netbeans.lib.awtextra.AbsoluteConstraints(500, 70, 80, 80));

        slot4.setIcon(new javax.swing.ImageIcon(getClass().getResource("/ConnectFour/blank.png"))); // NOI18N
        pnlBackground.add(slot4, new org.netbeans.lib.awtextra.AbsoluteConstraints(390, 70, 80, 80));

        slot3.setIcon(new javax.swing.ImageIcon(getClass().getResource("/ConnectFour/blank.png"))); // NOI18N
        pnlBackground.add(slot3, new org.netbeans.lib.awtextra.AbsoluteConstraints(285, 70, 80, 80));

        slot2.setIcon(new javax.swing.ImageIcon(getClass().getResource("/ConnectFour/blank.png"))); // NOI18N
        pnlBackground.add(slot2, new org.netbeans.lib.awtextra.AbsoluteConstraints(180, 70, 80, 80));

        slot1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/ConnectFour/blank.png"))); // NOI18N
        pnlBackground.add(slot1, new org.netbeans.lib.awtextra.AbsoluteConstraints(71, 70, 80, 80));

        slot8.setIcon(new javax.swing.ImageIcon(getClass().getResource("/ConnectFour/blank.png"))); // NOI18N
        pnlBackground.add(slot8, new org.netbeans.lib.awtextra.AbsoluteConstraints(71, 150, 80, 80));

        slot9.setIcon(new javax.swing.ImageIcon(getClass().getResource("/ConnectFour/blank.png"))); // NOI18N
        pnlBackground.add(slot9, new org.netbeans.lib.awtextra.AbsoluteConstraints(180, 150, 80, 80));

        slot10.setIcon(new javax.swing.ImageIcon(getClass().getResource("/ConnectFour/blank.png"))); // NOI18N
        pnlBackground.add(slot10, new org.netbeans.lib.awtextra.AbsoluteConstraints(285, 150, 80, 80));

        slot11.setIcon(new javax.swing.ImageIcon(getClass().getResource("/ConnectFour/blank.png"))); // NOI18N
        pnlBackground.add(slot11, new org.netbeans.lib.awtextra.AbsoluteConstraints(390, 150, 80, 80));

        slot12.setIcon(new javax.swing.ImageIcon(getClass().getResource("/ConnectFour/blank.png"))); // NOI18N
        pnlBackground.add(slot12, new org.netbeans.lib.awtextra.AbsoluteConstraints(500, 150, 80, 80));

        slot13.setIcon(new javax.swing.ImageIcon(getClass().getResource("/ConnectFour/blank.png"))); // NOI18N
        pnlBackground.add(slot13, new org.netbeans.lib.awtextra.AbsoluteConstraints(602, 150, 80, 80));

        slot14.setIcon(new javax.swing.ImageIcon(getClass().getResource("/ConnectFour/blank.png"))); // NOI18N
        pnlBackground.add(slot14, new org.netbeans.lib.awtextra.AbsoluteConstraints(710, 150, 80, 80));

        slot15.setIcon(new javax.swing.ImageIcon(getClass().getResource("/ConnectFour/blank.png"))); // NOI18N
        pnlBackground.add(slot15, new org.netbeans.lib.awtextra.AbsoluteConstraints(71, 225, 80, 80));

        slot16.setIcon(new javax.swing.ImageIcon(getClass().getResource("/ConnectFour/blank.png"))); // NOI18N
        pnlBackground.add(slot16, new org.netbeans.lib.awtextra.AbsoluteConstraints(180, 225, 80, 80));

        slot17.setIcon(new javax.swing.ImageIcon(getClass().getResource("/ConnectFour/blank.png"))); // NOI18N
        pnlBackground.add(slot17, new org.netbeans.lib.awtextra.AbsoluteConstraints(285, 225, 80, 80));

        slot18.setIcon(new javax.swing.ImageIcon(getClass().getResource("/ConnectFour/blank.png"))); // NOI18N
        pnlBackground.add(slot18, new org.netbeans.lib.awtextra.AbsoluteConstraints(390, 225, 80, 80));

        slot19.setIcon(new javax.swing.ImageIcon(getClass().getResource("/ConnectFour/blank.png"))); // NOI18N
        pnlBackground.add(slot19, new org.netbeans.lib.awtextra.AbsoluteConstraints(500, 225, 80, 80));

        slot20.setIcon(new javax.swing.ImageIcon(getClass().getResource("/ConnectFour/blank.png"))); // NOI18N
        pnlBackground.add(slot20, new org.netbeans.lib.awtextra.AbsoluteConstraints(602, 225, 80, 80));

        slot21.setIcon(new javax.swing.ImageIcon(getClass().getResource("/ConnectFour/blank.png"))); // NOI18N
        pnlBackground.add(slot21, new org.netbeans.lib.awtextra.AbsoluteConstraints(710, 225, 80, 80));

        slot22.setIcon(new javax.swing.ImageIcon(getClass().getResource("/ConnectFour/blank.png"))); // NOI18N
        pnlBackground.add(slot22, new org.netbeans.lib.awtextra.AbsoluteConstraints(71, 300, 80, 80));

        slot23.setIcon(new javax.swing.ImageIcon(getClass().getResource("/ConnectFour/blank.png"))); // NOI18N
        pnlBackground.add(slot23, new org.netbeans.lib.awtextra.AbsoluteConstraints(180, 300, 80, 80));

        slot24.setIcon(new javax.swing.ImageIcon(getClass().getResource("/ConnectFour/blank.png"))); // NOI18N
        pnlBackground.add(slot24, new org.netbeans.lib.awtextra.AbsoluteConstraints(285, 300, 80, 80));

        slot25.setIcon(new javax.swing.ImageIcon(getClass().getResource("/ConnectFour/blank.png"))); // NOI18N
        pnlBackground.add(slot25, new org.netbeans.lib.awtextra.AbsoluteConstraints(390, 300, 80, 80));

        slot26.setIcon(new javax.swing.ImageIcon(getClass().getResource("/ConnectFour/blank.png"))); // NOI18N
        pnlBackground.add(slot26, new org.netbeans.lib.awtextra.AbsoluteConstraints(500, 300, 80, 80));

        slot27.setIcon(new javax.swing.ImageIcon(getClass().getResource("/ConnectFour/blank.png"))); // NOI18N
        pnlBackground.add(slot27, new org.netbeans.lib.awtextra.AbsoluteConstraints(602, 300, 80, 80));

        slot28.setIcon(new javax.swing.ImageIcon(getClass().getResource("/ConnectFour/blank.png"))); // NOI18N
        pnlBackground.add(slot28, new org.netbeans.lib.awtextra.AbsoluteConstraints(710, 300, 80, 80));

        slot29.setIcon(new javax.swing.ImageIcon(getClass().getResource("/ConnectFour/blank.png"))); // NOI18N
        pnlBackground.add(slot29, new org.netbeans.lib.awtextra.AbsoluteConstraints(71, 380, 80, 80));

        slot30.setIcon(new javax.swing.ImageIcon(getClass().getResource("/ConnectFour/blank.png"))); // NOI18N
        pnlBackground.add(slot30, new org.netbeans.lib.awtextra.AbsoluteConstraints(180, 380, 80, 80));

        slot31.setIcon(new javax.swing.ImageIcon(getClass().getResource("/ConnectFour/blank.png"))); // NOI18N
        pnlBackground.add(slot31, new org.netbeans.lib.awtextra.AbsoluteConstraints(285, 380, 80, 80));

        slot32.setIcon(new javax.swing.ImageIcon(getClass().getResource("/ConnectFour/blank.png"))); // NOI18N
        pnlBackground.add(slot32, new org.netbeans.lib.awtextra.AbsoluteConstraints(390, 380, 80, 80));

        slot33.setIcon(new javax.swing.ImageIcon(getClass().getResource("/ConnectFour/blank.png"))); // NOI18N
        pnlBackground.add(slot33, new org.netbeans.lib.awtextra.AbsoluteConstraints(500, 380, 80, 80));

        slot34.setIcon(new javax.swing.ImageIcon(getClass().getResource("/ConnectFour/blank.png"))); // NOI18N
        pnlBackground.add(slot34, new org.netbeans.lib.awtextra.AbsoluteConstraints(602, 380, 80, 80));

        slot35.setIcon(new javax.swing.ImageIcon(getClass().getResource("/ConnectFour/blank.png"))); // NOI18N
        pnlBackground.add(slot35, new org.netbeans.lib.awtextra.AbsoluteConstraints(710, 380, 80, 80));

        slot36.setIcon(new javax.swing.ImageIcon(getClass().getResource("/ConnectFour/blank.png"))); // NOI18N
        pnlBackground.add(slot36, new org.netbeans.lib.awtextra.AbsoluteConstraints(71, 458, 80, 80));

        slot37.setIcon(new javax.swing.ImageIcon(getClass().getResource("/ConnectFour/blank.png"))); // NOI18N
        pnlBackground.add(slot37, new org.netbeans.lib.awtextra.AbsoluteConstraints(180, 458, 80, 80));

        slot38.setIcon(new javax.swing.ImageIcon(getClass().getResource("/ConnectFour/blank.png"))); // NOI18N
        pnlBackground.add(slot38, new org.netbeans.lib.awtextra.AbsoluteConstraints(285, 458, 80, 80));

        slot39.setIcon(new javax.swing.ImageIcon(getClass().getResource("/ConnectFour/blank.png"))); // NOI18N
        pnlBackground.add(slot39, new org.netbeans.lib.awtextra.AbsoluteConstraints(390, 458, 80, 80));

        slot40.setIcon(new javax.swing.ImageIcon(getClass().getResource("/ConnectFour/blank.png"))); // NOI18N
        pnlBackground.add(slot40, new org.netbeans.lib.awtextra.AbsoluteConstraints(500, 458, 80, 80));

        slot41.setIcon(new javax.swing.ImageIcon(getClass().getResource("/ConnectFour/blank.png"))); // NOI18N
        pnlBackground.add(slot41, new org.netbeans.lib.awtextra.AbsoluteConstraints(602, 458, 80, 80));

        slot42.setIcon(new javax.swing.ImageIcon(getClass().getResource("/ConnectFour/blank.png"))); // NOI18N
    ...
    //this method is called when the column 1 button is pressed in the game 
    private void btnColumn1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnColumn1ActionPerformed
        
        //sets selectedColumn variable to 0, with respect to a matrix of the gameboard
        selectedColumn = 0; 
        
        /* sends the game board matrix and selectedColumn to ConnectFourClass method 
         * in ConnectFourClass class to get the row to drop the piece in 
        */
        int row = cf.ConnectFourClass(connectFourBoard, selectedColumn);
        
        //shows error dialogue when -1 is returned 
        if(row == -1)
        {
            JOptionPane.showMessageDialog(gameboard, "An Error Has Occured");
        }
        
        //adds 1 to number of turns you made
        numberOfTurns++; 
        //sets the index to "Y" in the matrix according to where the piece was dropped 
        connectFourBoard[row][selectedColumn] = "Y";
        //calls the ChangeToYellow method to change the blank space to yellow
        ChangeToYellow(row, selectedColumn); 
        
        /*boolean to check is collumn is full by sending the game board and selected column to 
         * the columnFull methods in ConnectFourClass class
        */
        boolean isColumnFull = cf.columnFull(connectFourBoard, selectedColumn); 
        
        //if it is full, the index of this column is changed to -1 so the computer cannot select it
        //also it makes the column select button invisible so it cant be selected by the player
        ...
        //checks for winer by sending variables to checkForWin method in ConnectFourClass class
        int winner = cf.checkForWin(connectFourBoard);
        
        /*shows message saying user wins and changes to scoreboard screeen and calls winScoreBoardSetup
         * method when checkForWin returns a 1
        */
        if(winner == 1)
        {
        ...
        /*shows message saying it was a tie and changes to scoreboard screeen and calls ScoreBoardSetup
         * method when checkForWin returns a 3
        */
        else if(winner == 3)
        {
        ...
        {
            //sets max and min range of the cpuPickColumn array to be randomized 
            int min = 0; 
            int max = cpuPickColumn.length-1; 
            int columnPicked;
            
            //while loop that keeps randomizing column until the value in array isnt -1
            while(true)
            {
            ...
            //sends game board and columnPicked to ConnectFourClass method to get row of the piece
            row = cf.ConnectFourClass(connectFourBoard, columnPicked);
            //sets the index to "R" in the matrix according to where the piece was dropped 
            ...
            */
            ...
            /* the following if statements check if isColumnFull is true and then sets button 
             * invisible and chnges element in cpuPickColumn array to -1 depending on 
             * which column was randomly picked
            */
            ...
            /*shows message saying computer wins and changes to scoreboard screeen and calls ScoreBoardSetup
             * method when checkForWin returns a 2
            */
            if(winner == 2)
            {
                JOptionPane.showMessageDialog(gameboard, "Computer Wins, better luck next time!");
    ...
    //this method is the same as above but called when column 2 button is pressed
    ...
    //method runs when play button in main screen is pressed
    private void btnPlayMainActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnPlayMainActionPerformed
        
        //recieves nickname from user input and sets the text of text field to nickname
        name = txtName.getText(); 
        txtName.setText(name);
        
        //sets the elements in the connectFourBoard matrix to O, reresenting there is no piece there
        ...
        //if-else statement to check if nickname was entered by users
        ...
        //displays message if name was not entered
        else
        {
    ...
    //method runs when instruction button in main screen is pressed
    private void btnInstructionsMainActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnInstructionsMainActionPerformed
        ...
        //changes to instructions JFrame
    ...
    //method runs when credits button in main screen is pressed
    ...
    //method runs when back button in instructions screen is pressed
    private void btnBackActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnBackActionPerformed
        
        //changes to main JFrame
        frameMain.setVisible(true);
        frameMain.setSize(505, 495);
        frameMain.setDefaultCloseOperation(this.EXIT_ON_CLOSE);
    ...
    //method runs when back to main button in game screen is pressed
    private void btnBackToMainActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnBackToMainActionPerformed
        
        //resets all the variables and sets array back to original
        numberOfTurns = 0;
        selectedColumn = 0; 
        cpuPickColumn[0] = 0;
        cpuPickColumn[1] = 1;
        ...
        //sets all the icons back to blank 
        slot1.setIcon(blank); slot2.setIcon(blank); slot3.setIcon(blank); slot4.setIcon(blank); slot5.setIcon(blank); slot6.setIcon(blank); slot7.setIcon(blank);
        slot8.setIcon(blank); slot9.setIcon(blank); slot10.setIcon(blank); slot11.setIcon(blank); slot12.setIcon(blank); slot13.setIcon(blank); slot14.setIcon(blank);
        slot15.setIcon(blank); slot16.setIcon(blank); slot17.setIcon(blank); slot18.setIcon(blank); slot18.setIcon(blank); slot20.setIcon(blank); slot21.setIcon(blank);
        slot22.setIcon(blank); slot23.setIcon(blank); slot24.setIcon(blank); slot25.setIcon(blank); slot26.setIcon(blank); slot27.setIcon(blank); slot28.setIcon(blank);
        slot29.setIcon(blank); slot30.setIcon(blank); slot31.setIcon(blank); slot32.setIcon(blank); slot33.setIcon(blank); slot34.setIcon(blank); slot35.setIcon(blank);
        slot36.setIcon(blank); slot37.setIcon(blank); slot38.setIcon(blank); slot39.setIcon(blank); slot40.setIcon(blank); slot41.setIcon(blank); slot42.setIcon(blank);
    ...
    //method runs when back button in credits screen is pressed
    ...
    //method runs when exit button in scoreboard screen is pressed
    ...
    //method runs when exit button in main screen is pressed
    ...
    //this method changes the blank slots into the red piece
    private void ChangeToRed(int row, int col)
    {
        //switch case to go to respective column
        switch (col)
        {
            case 0: 
                    //switch case to go to respective row  and chnage respective icon 
                    switch (row)
                    {
    ...
    //this method changes the blank slots into the yellow piece
    //comments are identical to ChangeToYellow method
    ...
    /*winScoreboardSetup method is called when winner == 1
     *this method reads and writes the arraylist of names and scores to scoreboard.txt
     * The scores are also displayed to scoreboard. 
    */
    private boolean winScoreboardSetup()
    {
        //clears the socreboard to make sure text dosent add on to previous text
        txtScoreboard.setText("");
        //variables
        String word;
        int counter = 0; 
        
        //try and catch statement to read scoreboard.txt
        try
        {
            ...
            //while loop to keep reading file until there is no more 
            while ((word = readFile.readLine()) != null) 
            {
                 ...
                 if(counter%2 == 0)
                 {
                     //adds number value to Scoreboard arraylist of players number of turns
                     Scoreboard.add(Integer.parseInt(word)); 
                 }
                 //if line is odd
                 else
                 {
                     //adds player nickname to nameScoreboard arraylistof players nicknames 
                     nameScoreboard.add(word);
                 }
            }
        }
        //catch statement to catch any errors
        catch (IOException e) 
         {               
        ...
        //adds the current games player nickname and score to the array 
        nameScoreboard.add(name); 
        Scoreboard.add(numberOfTurns);
        
        //removes any nameScoreboard array elements which are blank
        ...
        //creates temp arrays of same size as arraylists
        int[] tempArray1 = new int[Scoreboard.size()]; 
        String[] tempArray2 = new String[nameScoreboard.size()]; 
        
        //adds all values from arrayListsto arrays
        ...
        //bubble sort algorithm to sort score from least number of turns to most number of turns
        {
            int IntTemp = 0;

            String stringTemp = null; 

            //nested for loop to make the sorting algorithm work multiple times to cover all indexes       
            for(int x = 0; x <= tempArray1.length-1; x++)
            {       
                for(int y = 1; y <= tempArray1.length-1; y++)
                {   
                    //compares element of array with previous element
                    if(tempArray1[y-1] > tempArray1[y])
                    {
                        //swaps the elements if previous element is larger 
        ...
        //for loop to set text in text field with players nicnnames and their scores
        ...
        try
        {
            //initializing file and buffered writer
            ...
            for(int i = 0; i <= tempArray1.length-1; i++) 
            {
                //if statement to make sure only 20 items are written to file because its a top 20 scoreboard
                if(tempArray1.length <= 20)
                {
                    //writes to scoreboard.txt
    ...
    /*ScoreboardSetup method is called when winner == 2 or winner == 3
     *this is different from winScoreboardSetup method because this does not write
     * scores to the scoreboard text file, it only displays the scoreboard  
     * the commens are the same as the winScoreboardSetup method
    */
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ConnectFour().setVisible(false);
            }
        });
    }
